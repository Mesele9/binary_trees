 ...
 *
 * Return: 1 if tree is a valid Max Binary Heap, 0 if tree is NULL or
 * 0 otherwise
 */
 ...
 * @tree: a pointer to the root node of the tree to check
 *
 * Return: 1 if tree is a valid Max Binary Heap, 1 if tree is NULL
 * or 0 otherwise
 */
 ...
 *
 * Return: 1 if the tree is complete, 0 if the tree is not
 * complete or 0 if tree is NULL
 */
